...
def drawText(args):
	...
	display.Draw_Info_Box_Text(x=20,y=20,w=400,h=280,size = 2,heading="Server data",body=size1_longstring)
	display.Draw_Char(450,250,0x3,0x0,3)
	display.Draw_Char(450,290,0x0,0x0,3)

def drawMain(args):
	display.Draw_Info_Box_Text(x=120,y=20,w=240,h=50,size = 2, heading="EZ-PY32",body="")
